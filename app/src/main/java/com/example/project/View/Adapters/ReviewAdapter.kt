...
import com.example.project.databinding.ReviewlayoutBinding
...
class ReviewAdapter(private val fragment: Fragment) : RecyclerView.Adapter<ReviewAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Picasso.get().load(review.profilePic).placeholder(R.drawable.ic_baseline_account_circle_24).into(holder.image)
