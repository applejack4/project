...
app.post("/createorder", (req, res) => {
  ...
  if (orderId != null && amount != null) {
              ...
              (error, response) => {
                if (error) {
                  ...
                  res
                    ...
                    .json({
                      message:
                        "Failed to generate order id! Try again after some time.",
                    });
                } else {
                  res
                    .status(201)
                    .json({ rzp_order_id: response.id, rzp_id: rzp_id });
                }
              }
            );
          }
    ...
    res
      .status(400)
      .json({ message: "order id or amount is missing from the body!" });
  }
});
